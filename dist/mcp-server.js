...
function createMcpServer(config = {}, client = null) {
    ...
    server.tool('get_messages', {
        ...
        limit: zod_1.z.number().describe('The number of messages to get (default: 10)'),
    ...
    server.tool('get_group_by_id', {
        groupId: zod_1.z.string().describe('The ID of the group to get'),
    }, async ({ groupId }) => {
        try {
    ...
    server.tool('download_media_from_message', {
        messageId: zod_1.z.string().describe('The ID of the message containing the media'),
    }, async ({ messageId }) => {
        try {
    ...
    server.tool('send_media_message', {
        number: zod_1.z.string().describe('The phone number to send the message to'),
        source: zod_1.z
            .string()
            .describe('The source of the media - URLs must use http:// or https:// prefixes, local files must use file:// prefix'),
        caption: zod_1.z.string().default('').describe('Caption for the media'),
